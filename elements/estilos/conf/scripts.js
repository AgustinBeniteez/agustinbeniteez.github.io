document.addEventListener('DOMContentLoaded', function() {
    ...
    $(document).ready(function() {
        ...
        $searchInput.on('keyup', function() {
            ...
            // Disable scroll event while searching
        ...
        $tagButtons.on('click', function() {
            ...
            // Disable scroll event while filtering by tags
            window.removeEventListener('scroll', onScrollLoadMore);
        });
        ...
        $searchInput.on('input', function() {
            ...
            if (searchTerm === '') {
                $noResultsMessage.hide();
                // Enable scroll event when search is cleared
...
function limpiarBusqueda() {
    ...
    // Enable scroll event when clearing search
    window.addEventListener('scroll', onScrollLoadMore);
}
